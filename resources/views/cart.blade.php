						...
						<tr>
							<th scope="row">
								<div class="form-group my-auto">
									...
									<img src="{{ Storage::url($cart->product->galleries->first()->photo) }}"
										class="img-fluid" alt="gambar produk" style="border-radius: 4px" />
									@endif
								</div>
							</th>
							<td>
							...
							<td>
								<div class="form-group my-auto py-1" style="width: 200px">
									<div class="quantity mt-1">
										<button class="btn text-white btn-minus qtyMinus me-4 changeQuantity"
											type="button" data-cartid="{{ $cart['id'] }}">
											<i class="fas fa-minus"></i>
										</button>
										<input type="number" name="quantity" value="{{ $cart->quantity }}"
											class="border-0 px-auto qty-input" style="max-width: 40px" disabled />
										<button class="btn text-white btn-plus qtyPlus changeQuantity" type="button"
											data-cartid="{{ $cart['id'] }}">
							...
							<td>
								<div class="form-group my-auto py-2" style="width: 130px">
									<div class="price">Rp. {{ number_format($cart->product->price * $cart->quantity) }}
									</div>
								</div>
							</td>
							<td>
										...
										<div class="table-responsive">
											...
											<table class="scroll-horizontal-vertical w-100">
												...
												<tr>
													<div class="form-group">
														<th>Harga</th>
														<td class="text-end">Rp.{{ number_format($cart->product->price)
															}}</td>
													</div>
												</tr>
												<tr>
											...
											<table class="scroll-horizontal-vertical w-100">
												<tr>
													<div class="form-group">
														...
														<td class="text-end"><strong class="text-success">Rp.{{
																number_format($totals + $admin_fee + $code_unique -
																$discounts ?? 0) }}</strong></td>
													</div>
												</tr>
											</table>
										</div>
